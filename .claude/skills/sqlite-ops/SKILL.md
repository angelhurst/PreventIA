...
Vendored from https://github.com/0xDarkMatter/claude-mods (MIT). The upstream skill ships three
further reference files (schema patterns, aiosqlite async patterns, version migrations) that were
deliberately not vendored; pull them from upstream if a need appears.
