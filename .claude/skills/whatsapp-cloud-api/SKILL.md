...
Vendored from https://github.com/bellopushon/whatsapp-cloud-api (MIT). The upstream skill ships seven
further reference files (messaging, templates, conversations, coexistence, media, interactive, phone
numbers) that were deliberately not vendored; pull them from upstream if a need appears.
