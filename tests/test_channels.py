...
import preventia.channels.console_session as console_module
from preventia.channels.base import InboundMessage, MessageKind, OutboundMessage
from preventia.channels.console_session import ConsoleSessionChannel
...
def test_text_message_reaches_the_handler_and_the_reply_goes_out():
    stdout = StringIO()
    channel = ConsoleSessionChannel(echo, "patient-001", stdin=StringIO(), stdout=stdout)
